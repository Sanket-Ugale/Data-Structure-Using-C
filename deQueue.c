...
void enQueueRear(int value)//push rear side/back
{   
     char ch;
     if(front == SIZE/2)
      {
...
void enQueueFront(int value)//push element in front side 
{   
     char ch;
     if(front==SIZE/2)
      {
...
int deQueueRear() //delete backside
{
     int deleted;
     if(front == rear)
     {
